...
BOOST_AUTO_TEST_CASE(ReorgChain)
{
    ...
    BOOST_REQUIRE(pDBView->GetUTXOs(block1_tx1_output1.GetHash()).empty());
    BOOST_REQUIRE(pCachedView->GetUTXOs(block1_tx1_output1.GetHash()).size() == 1);
    ...
    BOOST_REQUIRE(pDBView->GetUTXOs(block2_tx1_output1.GetHash()).empty());
    BOOST_REQUIRE(pCachedView->GetUTXOs(block2_tx1_output1.GetHash()).size() == 1);
    ...
    BOOST_REQUIRE(pCachedView->GetUTXOs(block1_tx1_output1.GetHash()).size() == 1);
    BOOST_REQUIRE(pCachedView->GetUTXOs(block2_tx1_output1.GetHash()).empty());
    miner.Rewind(1);
    ...
    BOOST_REQUIRE(BlockValidator::ValidateBlock(block3.GetBlock(), block3.GetHash(), {block3_tx1.GetPegInCoin()}, {}));
    pCachedView->ApplyBlock(block3.GetBlock());

    const auto& block3_tx1_output1 = block3_tx1.GetOutputs()[0];
    BOOST_REQUIRE(pDBView->GetUTXOs(block3_tx1_output1.GetHash()).empty());
    BOOST_REQUIRE(pCachedView->GetUTXOs(block3_tx1_output1.GetHash()).size() == 1);
    ...
    BOOST_REQUIRE(pDBView->GetUTXOs(block1_tx1_output1.GetHash()).size() == 1);
    BOOST_REQUIRE(pCachedView->GetUTXOs(block1_tx1_output1.GetHash()).size() == 1);
    BOOST_REQUIRE(pDBView->GetUTXOs(block2_tx1_output1.GetHash()).empty());
    BOOST_REQUIRE(pCachedView->GetUTXOs(block2_tx1_output1.GetHash()).empty());
    BOOST_REQUIRE(pDBView->GetUTXOs(block3_tx1_output1.GetHash()).size() == 1);
    BOOST_REQUIRE(pCachedView->GetUTXOs(block3_tx1_output1.GetHash()).size() == 1);
}

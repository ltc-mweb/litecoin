...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeout = 2427264; // 364 days later
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeout = 2419200;     // 364 days later
